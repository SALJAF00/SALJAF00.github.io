    ...
    [0], {
            ...
            e.exports = function(e) {
                e.params({
                    ...
                    return {
                        ...
                        widget_site_screen_name: d(u.val("site")),
                        widget_site_user_id: l.asNumber(u.val("site:id")),
                        widget_creator_screen_name: d(u.val("creator")),
                        widget_creator_user_id: l.asNumber(u.val("creator:id"))
                    }
                }), e.define("scribe", function(e, t, r) {
                    var n = this;
                    return o.getHorizonSettings().then(function(o) {
                        var s = {
                            session_id: o.sessionId
                        };
                        e = a.aug(n.scribeNamespace(), e || {}), t = a.aug(n.scribeData(), t || {}), i.clientEvent(e, t, !1, r, s)
                    })
                }), e.define("scribeInteraction", function(e, t, r) {
                    var i = n.extractTermsFromDOM(e.target);
                    return i.action = e.type, "url" === i.element && (i.element = n.clickEventElement(e.target)), this.scribe(i, t, r)
                })
            }
        },
        173: function(e, t, r) {
        ...
        181: function(e, t, r) {
            var i = r(35),
                n = r(171),
                o = r(179);
            e.exports = n.couple(r(172), function(e) {
                e.selectors({
        ...
        187: function(e, t, r) {
            ...
            e.exports = n.couple(r(172), function(e) {
                e.selectors({
                    ...
                    return r.action = "seen", this.scribe(r, t)
        ...
        202: function(e, t, r) {
            ...
            e.exports = o.couple(r(172), function(e) {
                e.selectors({
        ...
        205: function(e, t, r) {
            var i = r(171),
                n = r(218),
                o = 1;
            e.exports = i.couple(r(172), function(e) {
                var t = {
                        action: "dimensions"
                    },
                    r = new n(o);
